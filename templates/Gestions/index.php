...
<div class="w-full max-w-content mx-auto">
  <div class="w-full flex flex-col items-center justify-center gap-10">
    ...
    <section class="w-full">
      <div class="mx-auto max-w-[1040px] rounded-2xl text-white px-8 py-10 shadow-card bg-gradient-to-r from-blue-600 to-blue-800">
    ...
    <!-- CARDS -->
    <section class="w-full grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-[980px]">
      <!-- Connexion -->
    ...
    <!-- FEATURES -->
    <section class="w-full max-w-[980px] mt-4 bg-gradient-to-b from-[#f7faff] to-[#f4f8ff] border border-[#e6eefc] rounded-xl p-4 shadow-sm">
